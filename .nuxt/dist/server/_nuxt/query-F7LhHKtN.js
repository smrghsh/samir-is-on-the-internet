...
import { a as useRequestEvent, u as useContentPreview } from "./preview-B122VS9C.js";
import "destr";
import "klona";
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import("./client-db-Dwxdo7UW.js").then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-F7LhHKtN.js.map
